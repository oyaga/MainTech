  ...
  <section ref="sectionRef" class="bg-gradient-to-b from-[#1A1201] to-[#AF8019] text-white py-20">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div>
          <h2 class="text-5xl font-bold mb-6">Temos as ferramentas ideais para suas necessidades</h2>
          <p class="text-2xl font-light">
            Fornecemos suporte especializado e soluções confiáveis para garantir que sua operação nunca pare. Nossa experiência e tecnologia trabalham a seu favor.
          </p>
        </div>
        <div class="flex flex-col gap-6">
          ...
          <div class="opacity-0 translate-y-4 transition-all duration-700" :class="{ 'opacity-100 translate-y-0': isVisible }">
            <div class="flex items-center justify-between mb-2">
              <h3 class="text-2xl font-bold">Redução de custos operacionais</h3>
          ...
          <div class="opacity-0 translate-y-4 transition-all duration-700 delay-500" :class="{ 'opacity-100 translate-y-0': isVisible }">
            <div class="flex items-center justify-between mb-2">
              <h3 class="text-2xl font-bold">Aumento da produtividade</h3>
          ...
          <div class="opacity-0 translate-y-4 transition-all duration-700 delay-1000" :class="{ 'opacity-100 translate-y-0': isVisible }">
            <div class="flex items-center justify-between mb-2">
              <h3 class="text-2xl font-bold">Precisão na entrega de projetos</h3>
